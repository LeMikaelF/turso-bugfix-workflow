...
1. **Orchestrator** - TypeScript workflow controller that manages the state machine, spawns Claude Code agents in AgentFS sandboxes, handles timeouts, and opens PRs
